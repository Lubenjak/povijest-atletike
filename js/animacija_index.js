...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const heroElements = document.querySelectorAll('.hero-content, .hero-title, .hero-subtitle');
    heroElements.forEach(el => heroObserver.observe(el));
    
    // Ostali elementi - dvosmerne animacije
    const regularElements = document.querySelectorAll('.history-title, .history-item, .category-card, .footer-content');
