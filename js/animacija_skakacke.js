// Scroll animations for skakacke.html
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const regularElements = document.querySelectorAll('.section-title, .discipline, .facts-title, .fact-item, .record-card, .back-button, .footer-content');
